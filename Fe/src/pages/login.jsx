    ...
    <div className="flex min-h-screen bg-[#FAF5EF] w-full items-center justify-center p-4 font-sans selection:bg-[#B38E5D] selection:text-white">
      ...
      <style>
        {`
          ...
          .animate-container {
            animation: loginContainerAppear 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards;
          }
          .animate-fade-up {
      ...
      <div className="flex w-full max-w-[1100px] min-h-[680px] bg-white rounded-2xl shadow-2xl overflow-hidden border border-[#D7C4B0]/60 animate-container">
        ...
        <div className="hidden md:flex flex-1 bg-[#261C19] text-[#FAF5EF] p-12 flex-col justify-between items-center relative select-none">
          <div className="absolute inset-0 opacity-30 mix-blend-luminosity pointer-events-none overflow-hidden">
            <img 
              src="https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?q=80&w=800&auto=format&fit=crop" 
              alt="Building Architecture" 
              className="w-full h-full object-cover grayscale contrast-125 scale-105 transition-transform duration-1000 hover:scale-110"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#261C19] via-[#261C19]/40 to-transparent"></div>
          </div>
          
          <div className="relative z-10 w-full flex justify-between items-center animate-fade-up delay-100">
          ...
          <div className="relative z-10 flex flex-col items-center text-center my-auto animate-fade-up delay-200">
            <div className="mb-6 p-4 bg-[#261C19]/80 border border-[#B38E5D]/30 rounded-2xl backdrop-blur-md shadow-xl hover:rotate-3 transition-transform duration-500">
          ...
          <div className="relative z-10 text-[11px] text-[#D7C4B0]/60 tracking-wider animate-fade-up delay-300">
        ...
        <div className="flex-1 bg-white p-6 sm:p-8 md:p-12 flex flex-col justify-between items-center text-[#261C19]">
          <div className="w-full max-w-[400px] mx-auto my-auto space-y-5">
            ...
            {/* Header Login */}
            <div className="text-center space-y-1 animate-fade-up delay-100">
            ...
            <div className="bg-[#FAF5EF] p-1 rounded-xl border border-[#D7C4B0]/50 flex gap-1 shadow-inner animate-fade-up delay-200">
              <button
                type="button"
                onClick={() => setRole('customer')}
                className={`flex-1 py-2 text-[11px] font-bold uppercase tracking-wider rounded-lg transition-all duration-300 cursor-pointer ${
            ...
            <div className="flex flex-col items-center text-center space-y-2 py-1 animate-fade-up delay-300">
              <div key={role} className={`w-14 h-14 bg-white border-2 rounded-full flex items-center justify-center transition-all duration-300 shadow-sm animate-icon-pop ${activeConfig.borderColor}`}>
                {role === 'superadmin' ? (
            ...
            {/* FORM LOGIN */}
            <form onSubmit={handleSubmit} className="space-y-3 animate-fade-up delay-400">
              ...
              <button 
                type="submit" 
                disabled={loading}
                className={`w-full text-white py-3 text-xs font-bold uppercase tracking-widest rounded-lg transition-all shadow-md duration-300 disabled:opacity-50 mt-2 cursor-pointer hover:-translate-y-0.5 active:translate-y-0 ${activeConfig.btnColor}`}
              >
            ...
            <div className="text-center text-xs font-medium text-gray-600 pt-1 animate-fade-up delay-400">
          ...
          <div className="text-center text-[10px] font-semibold text-gray-400 uppercase mt-4 tracking-wider animate-fade-up delay-400">
